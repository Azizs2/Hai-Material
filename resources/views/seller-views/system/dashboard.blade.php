            ...
            <div class="card-body">
                <div class="flex-between row gx-2 gx-lg-3 mb-2">
                    <div class="col-12 col-md-6"
                        style="{{ Session::get('direction') === 'rtl' ? 'margin-right:2px' : '' }};">
            ...
            <div class="card-body">
                ...
                <div class="row">
                                ...
                                <div class="flex-between row no-gutters align-items-center">
                                    ...
                                    <div>
                                        <a href="javascript:" style="background: #d1cfcf!important;"
                                            class="btn btn-primary text-color-1" data-toggle="modal"
                    ...
                    <div class="col-xl-6 for-card col-md-6 mt-4" style="cursor: pointer">
                        <div class="card  shadow h-100 for-card-body-3 badge-info" style="background: #EEEEEE!important;">
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-color-1 font-weight-bold for-card-text text-uppercase mb-1">
                                            {{ \App\CPU\translate('withdrawn') }}</div>
                                        <div class="text-color-1 for-card-count">
