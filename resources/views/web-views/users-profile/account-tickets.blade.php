...
@section('content')
    ...
    <div class="modal fade rtl" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};" id="open-ticket" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        ...
                        <table class="table">
                            ...
                            @foreach($allTickets as $ticket)
                                <tr>
                                    ...
                                    <td class="bodytr">
                                        <span class="">
                                            <a class="btn btn-primary btn-sm" href="{{route('support-ticket.index',$ticket['id'])}}">{{\App\CPU\translate('View')}}
                                            </a>
                                        </span>
                                    </td>
