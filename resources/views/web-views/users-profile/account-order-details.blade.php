...
@section('content')
        ...
        <div class="row">
            ...
            <section class="col-lg-9 col-md-9">
                        ...
                        <table class="table table-borderless">
                            <tbody class="totals">
                                <tr>
                                    <td>
                                        <div class="text-{{ Session::get('direction') === 'rtl' ? 'right' : 'left' }}">
                                            <span class="product-qty ">{{ \App\CPU\translate('Item') }}</span></div>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <div class="text-{{ Session::get('direction') === 'rtl' ? 'right' : 'left' }}">
                                            <span class="product-qty ">{{ \App\CPU\translate('text_fee') }}</span>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="text-{{ Session::get('direction') === 'rtl' ? 'left' : 'right' }}">
                ...
                <div class="justify-content mt-4 for-mobile-glaxy ">
                    ...
                    <button class="btn btn-primary for-glaxy-mobile" style="width:33%;" data-target="#bank_transfer" data-toggle="modal" type="button">
                        {{ \App\CPU\translate('payment_transfer') }}
                    </button>
    ...
    {{--modal payment_transfer --}}
    <div class="modal fade" id="bank_transfer" tabindex="-1" role="dialog" aria-labelledby="locationTransferLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="border-radius: 2em;">
                <div class="modal-header">
                    <h5 class="modal-title font-nameA" id="locationTransferLabel">{{\App\CPU\translate('payment_transfer')}}</h5>
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <div class="card box-shadow" style="height: 60px;">
                            <div style="display: flex; align-items: center;">
                                <img width="150" src="{{asset('public/assets/front-end/img/bank_mandiri.png')}}"/>
                                <p style="padding-top: 30px; padding-left:40px;">PT. Sentra Media Investama</p>
                            </div>
                            <h6 style="text-align: center; font-weight: bold;">12334567</h6>
                        </div>
                        <div class="card box-shadow" style="height: 60px; margin-top:5px">
                            <div style="display: flex; align-items: center;">
                                <img width="150" src="{{asset('public/assets/front-end/img/bank_bca.png')}}"/>
                                <p style="padding-top: 10px; padding-left:40px;">PT. Sentra Media Investama</p>
                            </div>
                            <h6 style="text-align: center; font-weight: bold;">12334567</h6>
                        </div>
                        <div class="card box-shadow" style="height: 60px; margin-top:5px">
