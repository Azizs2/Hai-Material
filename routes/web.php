...
Route::group(['namespace' => 'Web','middleware'=>['maintenance_mode']], function () {
    ...
    Route::group(['middleware'=>['customer']], function () {
        ...
        // checkout transfer
        Route::get('checkout-transfer', 'WebController@checkout_transfer')->name('checkout-transfer')->middleware('customer');
...
// The callback url after a payment
Route::get('/mandiri', 'MandiriController@index')->name('mandiri');
Route::get('/mandiri-payment', 'MandiriController@payment')->name('mandiri-payment');
